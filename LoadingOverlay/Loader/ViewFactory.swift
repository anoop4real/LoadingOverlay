...
//  UIProgramatically
//
//  Created by anoop on 2018-10-18.
...
class ViewFactory: NSObject {
    ...
    class func createAView(with backgroundColor: UIColor = UIColor.white, tintColor: UIColor = UIColor.blue, cornerRadius: CGFloat = 0.0) -> UIView {
